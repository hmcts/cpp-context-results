...
public class ResultsEventStreamArchiverTest {
    ...
    public void shouldSetCustomActionForEventsThatMatch() {
        final JsonEnvelope event = buildEnvelope("results.event.nows-material-status-updated.archived.2.4.release");
    ...
    public void shouldCreateTransformation() {
        ...
        assertThat(transformedEvents.get(0).metadata().name(), is("results.event.nows-material-status-updated"));
