...
public class ResultsEventStreamArchiverTest {
    ...
    public void shouldSetCustomActionForEventsThatMatch() {
        final JsonEnvelope event = buildEnvelope("results.add-hearing-result.archived.1.9.release");
    ...
    public void shouldCreateTransformation() {
        ...
        assertThat(transformedEvents.get(0).metadata().name(), is("results.add-hearing-result"));
