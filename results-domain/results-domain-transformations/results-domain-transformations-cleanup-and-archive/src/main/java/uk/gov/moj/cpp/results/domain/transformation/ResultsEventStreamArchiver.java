...
public class ResultsEventStreamArchiver implements EventTransformation {
    ...
    private static final List<String> EVENTS_TO_ARCHIVE = newArrayList(
            "results.hearing-details-added-for-hearing",
            "results.hearing-details-ignored",
            "results.resultline-added-for-hearing",
            "results.person-details-ignored",
            "results.resultline-deletion-ignored",
            "results.person-details-added-for-hearing",
            "results.resultline-deleted-for-hearing",
            "results.resultline-ignored",
            "results.add-hearing-result",
            "results.amend-hearing-result"
    );
