...
class HearingFinancialResultsAggregateNCESTest {
    ...
    public static Stream<Arguments> caseAmendmentScenarios() {
        return Stream.of(
                ...
                Arguments.of("SRIVANI::fin > nonfin (FO -> FO:deleted + CD:Added) (One GOB A/C) (DD-36847 AC3)",
                        newScenario()
                                .newStep(newResultTrackedStep("case resulted")
                        ...
                        newScenario()
                                ...
                                .newStep(newResultTrackedStep("case amended")
                                        .withResultTrackedEvent("json/nces/case-amendments/multi-offences/fine-amend-ds-acon/case_amended.json",
                                                emptyAccountInfo())
                                        .withExpectedEventNames("HearingFinancialResultsTracked", "NcesEmailNotificationRequested", "NcesEmailNotificationRequested", "NcesEmailNotificationRequested")
                                        .withExpectedEventPayloadEquals("NcesEmailNotificationRequested", "json/nces/case-amendments/multi-offences/fine-amend-ds-acon/nces_notification_expected.json",
                                                comparison()
                                                        .withPathsExcluded("materialId", "notificationId")
                                                        .withParam("gobAccountNumber", "11c39541-e8e0-45b3-af99-532b33646b69ACCOUNT"))
    ...
    public static Stream<Arguments> finCaseSingleOffenceAppAmendmentScenarios() {
        return Stream.of(
                ...
                Arguments.of("SRIVANI:::single offence > case fin > app fin,ds > fin DD-36848 SC5",
                        newScenario()
                                .newStep(newResultTrackedStep("case resulted")
    ...
    public static Stream<Arguments> finCaseMultiOffenceAppAmendmentScenarios() {
        return Stream.of(
                ...
                Arguments.of("SRIVANI::multi results > case fin > app fin,ds > app amendment fine,ds DD-34580 SC2",
                        newScenario()
                                .newStep(newResultTrackedStep("case resulted")
                ...
                Arguments.of("SRIVANI2:::Reopen > mutlioffence >  > Fine,FVS,ACON+Fine,FIDICI > Fine changed",
                        newScenario()
                                .newStep(newResultTrackedStep("case resulted")
    ...
    public static Stream<Arguments> nonFinCaseMultiOffenceAppAmendmentScenarios() {
        return Stream.of(
                ...
                Arguments.of("SRIVANI:::multi result- case non fine>application fine,ds>amendment fine,ds(DD-34580 SC2))",
                        newScenario()
                                .newStep(newResultTrackedStep("application resulted")
