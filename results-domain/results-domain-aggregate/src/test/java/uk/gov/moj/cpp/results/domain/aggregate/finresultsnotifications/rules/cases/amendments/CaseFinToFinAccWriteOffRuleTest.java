...
class CaseFinToFinAccWriteOffRuleTest {
    private final ResultNotificationRule rule = new CaseFinToFinAccWriteOffRule();
        ...
        HearingFinancialResultRequest trackRequest = hearingFinancialResultRequest()
                ...
                .withOffenceResults(List.of(
                        ...
                        offenceResults()
                                ...
                                .withIsFinancial(true)
                                .withImpositionOffenceDetails("Amended  Acc fin Offence details")
                                .withAmendmentDate("2023-01-01")
                                .build()))
                .build();
        final ResultNotificationRule.RuleInput input = resultNotificationRuleInputBuilder()
                ...
                .withCorrelationItemList(
                        List.of(correlationItem()
                                ...
                                correlationItem()
                                        ...
                                        .withHearingId(hearingId)
                                        .withOffenceResultsDetailsList(List.of(offenceResultsDetails().withOffenceId(offenceId1).withIsFinancial(true).build(),
                                                offenceResultsDetails().withOffenceId(offenceId2).withIsFinancial(true).build()))
                                        .withAccountNumber("AC123456789")
                                        .build()))
                .build();
        ...
        final ResultNotificationRule.RuleInput input = resultNotificationRuleInputBuilder()
                ...
                .withCorrelationItemList(
                        List.of(correlationItem()
                                ...
                                correlationItem()
                                        .withCreatedTime(ZonedDateTime.now())
                                        .withAccountCorrelationId(accountCorrelationId3)
                                        .withOffenceResultsDetailsList(List.of(offenceResultsDetails().withOffenceId(offenceId1).withIsFinancial(true).build(),
                                                offenceResultsDetails().withOffenceId(offenceId2).withIsFinancial(true).build()))
                                        .withAccountNumber("AC123456789")
                                        .withHearingId(hearingId)
    ...
    void shouldHandleMissingAmendmentDate() {
        ...
        assertThat("Rule should apply for financial to financial-financial transition", rule.appliesTo(input), is(true));
        final var output = rule.apply(input);
        assertThat("Rule should generate A&R for partial resulting with financials",output.isEmpty(), is(false));
    }
                ...
                .withCorrelationItemList(
                        List.of(correlationItem()
                                ...
                                .withOffenceResultsDetailsList(List.of(
                                        offenceResultsDetails().withOffenceId(offenceId1).withIsFinancial(true).build(),
                                        offenceResultsDetails().withOffenceId(offenceId2).withIsFinancial(true).build(),
                                        offenceResultsDetails().withOffenceId(offenceId3).withIsFinancial(true).build()))
                                .withAccountNumber("AC123456789")
                                .build()))
                .build();
